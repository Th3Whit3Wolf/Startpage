var quotes = [
	...
	{
		author:
			'"The C++ Programming Language". Book by Bjarne Stroustrup, October 1985.',
		id: 249,
		quote:
	...
	{
		author:
			"Richard P. Feynman, Surely Yo're Joking, Mr. Feynman!: Adventures of a Curious Character",
		id: 196,
		quote:
...
function showQuote() {
	...
	var quoteBox = document.querySelector('#quote p');
	var quoteCite = document.querySelector('cite');
	quoteBox.textContent = quotes[quoteID].quote;
	quoteCite.textContent = quotes[quoteID].author;
}
showQuote();
